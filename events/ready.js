...
module.exports = client => {
  ...
  function setActivity() {
    const Gameinfo = [`Using ${(((process.memoryUsage().heapUsed)/1024)/1024).toFixed(0)}MBs of RAM`, 'Source: https://github.com/Helldemon2017', 'Developer: Panda Dev#6666', 'Discord: https://discord.gg/ebbD2nZ', 'Invite: ', `Running on ${client.guilds.size} ${pluralnonpluralservers}`, `Running for ${client.users.size} ${pluralnonpluralusers}`, `Use ${config.prefix}help`];
